...
def test_cap_deprecated_cap_req_ack(mockbot: Sopel):
    mockfn = mock.Mock()
    mockbot.cap_req(
        'example',
        'example/cap',
        failure_callback=mockfn.cap_failure,
        success_callback=mockfn.cap_success,
    )
    mockbot.cap_req(
        'example',
        '=example/req',
        failure_callback=mockfn.req_failure,
        success_callback=mockfn.req_success,
    )
    mockbot.cap_req(
        'example',
        '-example/cap2',
        failure_callback=mockfn.cap2_failure,
        success_callback=mockfn.cap2_success,
    )
    mockbot.cap_req(
        'example',
        '~example/req2',
        failure_callback=mockfn.req2_failure,
        success_callback=mockfn.req2_success,
    )
    assert mockbot.cap_requests.is_registered(('example/cap',))
    assert mockbot.cap_requests.is_registered(('example/req',))
    assert mockbot.cap_requests.is_registered(('-example/cap2',))
    assert mockbot.cap_requests.is_registered(('-example/req2',))

    mockbot.on_message(
        ':irc.example.com CAP * LS '
        ':example/cap example/cap2 example/req example/req2',
    )
    assert mockbot.backend.message_sent == rawlist(
        'CAP REQ :example/cap',
        'CAP REQ :example/req',
        'CAP REQ :-example/cap2',
        'CAP REQ :-example/req2',
    )

    mockbot.on_message(':irc.example.com CAP * ACK :example/cap')
    mockfn.cap_success.assert_called_once()
    mockfn.cap_failure.assert_not_called()

    mockbot.on_message(':irc.example.com CAP * ACK :-example/cap2')
    mockfn.cap2_success.assert_called_once()
    mockfn.cap2_failure.assert_not_called()

    mockbot.on_message(':irc.example.com CAP * ACK :example/req')
    mockfn.req_success.assert_called_once()
    mockfn.req_failure.assert_not_called()

    mockbot.on_message(':irc.example.com CAP * ACK :-example/req2')
    mockfn.req2_success.assert_called_once()
    mockfn.req2_failure.assert_not_called()
...
def test_cap_deprecated_cap_req_nak(mockbot: Sopel):
    mockfn = mock.Mock()
    mockbot.cap_req(
        'example',
        'example/cap',
    ...
    mockbot.on_message(':irc.example.com CAP * NAK :example/cap')
    mockfn.cap_success.assert_not_called()
    mockfn.cap_failure.assert_called_once()

    mockbot.on_message(':irc.example.com CAP * NAK :-example/cap2')
    mockfn.cap2_success.assert_not_called()
    mockfn.cap2_failure.assert_called_once()

    mockbot.on_message(':irc.example.com CAP * NAK :example/req')
    mockfn.req_success.assert_not_called()
    mockfn.req_failure.assert_called_once()

    mockbot.on_message(':irc.example.com CAP * NAK :-example/req2')
    mockfn.req2_success.assert_not_called()
    mockfn.req2_failure.assert_called_once()
