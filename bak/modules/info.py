...
def commands(phenny, input): 
   ...
   phenny.msg(str(input.nick),'Commands I recognise: ' + names + '.')
   phenny.msg(str(input.nick),("For help, do '%s: help example?' where example is the " + 
               "name of the command you want help for.") % phenny.nick)
commands.commands = ['commands']
commands.priority = 'low'

def commandsmsg(phenny, input):
    phenny.say(str(input.nick) + ", I'll be sending you a private message of all my commands!")
    phenny.msg(input.nick, "Hi, " + str(input.nick) + ", you have initiated my commands function.")
    commands(phenny, input) 
#commandsmsg.commands = ['commands']
